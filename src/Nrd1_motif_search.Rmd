...
id_file_TTCTTGTW1_up100 <- paste(here::here(), "results", "Ca_id_list_TTCTTGTW1_up100.txt", sep = "/")
motif_count_up_df %>%
    filter(count_up100 >= 1) %>%
    pull(id) %>%
    write_lines(file = id_file_TTCTTGTW1_up100)
id_file_TTCTTGTW2_up100 <- paste(here::here(), "results", "Ca_id_list_TTCTTGTW2_up100.txt", sep = "/")
motif_count_up_df %>%
...
id_file_TTCTTGTW1_CDS <- paste(here::here(), "results", "Ca_id_list_TTCTTGTW1_CDS.txt", sep = "/")
motif_count_CDS_df %>% 
  filter(count_CDS >= 1) %>% 
  pull(id) %>% 
  write_lines(file = id_file_TTCTTGTW1_CDS)
id_file_TTCTTGTW2_CDS <- paste(here::here(), "results", "Ca_id_list_TTCTTGTW2_CDS.txt", sep = "/")
motif_count_CDS_df %>% 
  filter(count_CDS >= 2) %>% 
  pull(id) %>%
...
id_file_TTCTTGTW1_down100 <- paste(here::here(), "results", "Ca_id_list_TTCTTGTW1_down100.txt", sep = "/")
motif_count_down_df %>%
    filter(count_down100 >= 1) %>%
    pull(id) %>%
    write_lines(file = id_file_TTCTTGTW1_down100)
id_file_TTCTTGTW2_down100 <- paste(here::here(), "results", "Ca_id_list_TTCTTGTW2_down100.txt", sep = "/")
motif_count_down_df %>%
    filter(count_down100 >= 2) %>%
    pull(id) %>%
    write_lines(file = id_file_TTCTTGTW2_down100)
```