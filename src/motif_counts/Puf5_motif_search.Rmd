...
id_file_WTTGTAWTWT1_up100 <- paste(here::here(), "results", "Motif Searches", "Puf5", "Ca_id_list_WTTGTAWTWT1_up100.txt", sep = "/")
motif_count_up_df %>%
    filter(count_up100 >= 1) %>%
    pull(id) %>%
    write_lines(file = id_file_WTTGTAWTWT1_up100)
id_file_WTTGTAWTWT2_up100 <- paste(here::here(), "results", "Motif Searches", "Puf5", "Ca_id_list_WTTGTAWTWT2_up100.txt", sep = "/")
motif_count_up_df %>%
...
id_file_WTTGTAWTWT1_CDS <- paste(here::here(), "results", "Motif Searches", "Puf5", "Ca_id_list_WTTGTAWTWT1_CDS.txt", sep = "/")
motif_count_CDS_df %>% 
  filter(count_CDS >= 1) %>% 
  pull(id) %>% 
  write_lines(file = id_file_WTTGTAWTWT1_CDS)
id_file_WTTGTAWTWT2_CDS <- paste(here::here(), "results", "Motif Searches", "Puf5", "Ca_id_list_WTTGTAWTWT2_CDS.txt", sep = "/")
motif_count_CDS_df %>% 
  filter(count_CDS >= 2) %>% 
  pull(id) %>%
  write_lines(file = id_file_WTTGTAWTWT2_CDS)
```
```{r gene_list_output_down}
id_file_WTTGTAWTWT1_down200 <- paste(here::here(), "results", "Motif Searches", "Puf5", "Ca_id_list_WTTGTAWTWT1_down200.txt", sep = "/")
motif_count_down_df %>%
    filter(count_down200 >= 1) %>%
    pull(id) %>%
    write_lines(file = id_file_WTTGTAWTWT1_down200)
id_file_WTTGTAWTWT2_down200 <- paste(here::here(), "results", "Motif Searches", "Puf5", "Ca_id_list_WTTGTAWTWT2_down200.txt", sep = "/")
motif_count_down_df %>%
    filter(count_down200 >= 2) %>%
    pull(id) %>%
    write_lines(file = id_file_WTTGTAWTWT2_down200)
```