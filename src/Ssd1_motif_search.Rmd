...
id_file_AKTCATTCCTT1_up100 <- paste(here::here(), "results", "Ca_id_list_AKTCATTCCTT1_up100.txt", sep = "/")
motif_count_up_df %>%
    filter(count_up100 >= 1) %>%
    pull(id) %>%
    write_lines(file = id_file_AKTCATTCCTT1_up100)
id_file_AKTCATTCCTT2_up100 <- paste(here::here(), "results", "Ca_id_list_AKTCATTCCTT2_up100.txt", sep = "/")
motif_count_up_df %>%
...
id_file_AKTCATTCCTT1_down100 <- paste(here::here(), "results", "Ca_id_list_AKTCATTCCTT1_down100.txt", sep = "/")
motif_count_down_df %>%
    filter(count_down100 >= 1) %>%
    pull(id) %>%
    write_lines(file = id_file_AKTCATTCCTT1_down100)
id_file_AKTCATTCCTT2_down100 <- paste(here::here(), "results", "Ca_id_list_AKTCATTCCTT2_down100.txt", sep = "/")
motif_count_down_df %>%
    filter(count_down100 >= 2) %>%
    pull(id) %>%
    write_lines(file = id_file_AKTCATTCCTT2_down100)
```